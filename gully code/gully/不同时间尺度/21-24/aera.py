...
data = pd.read_excel(file_path, sheet_name=4)  # 使用 sheet_name=4，即面积的数据
...
bar_plot = sns.barplot(x='Contribution', y='Factor', data=contribution_ratio_df, palette=gradient_palette, hue='Factor', dodge=False, legend=False, orient='h')
...
plt.title('21-24 Factor Contribution to Gully Area', fontsize=16)
